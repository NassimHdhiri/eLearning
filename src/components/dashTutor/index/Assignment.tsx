...
<div className="overflow-y-auto h-[292px] absolute bottom-14 w-60 m-auto ml-5 max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    <div className="flex items-center justify-between mb-4">
        <h5 className=" text-base font-bold leading-none text-gray-900 dark:text-white">Assignments</h5>
        <Link to="/tutor/id/assignment" className=" text-xs font-medium text-blue-600 hover:underline dark:text-blue-500 underline">
            View all
        </Link>
   </div>
